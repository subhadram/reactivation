...
def main(trial):
        ...
        for eps in range(len(epsilon)):
            ...
            for j in range(trials):
               ...
               """
                ...
                filt_rate = filt_rate - np.mean(filt_rate)
                filt_rate = filt_rate / np.sqrt(dtf)
                r_factor4 = np.maximum(filt_rate + 0.5, 0)
                ...
                noise_EE[0:group1ei,:] = noise_EE[0:group1ei,:] * (np.random.rand(Ng1, Nt) < np.outer(np.ones(Ng1), (r_factor1+r_factor3)/2))
                noise_EE[group2si:group2ei,:] = noise_EE[group2si:group2ei,:] * (np.random.rand(Ng2, Nt) < np.outer(np.ones(Ng2), (r_factor2+r_factor3)/2))
                noise_EE[group2ei:inhind,:] = noise_EE[group2ei:inhind,:] * (np.random.rand(int(0.05*N), Nt) < np.outer(np.ones(int(0.05*N)), r_factor4))
    ...
    #pickle.dump(mratecsd,open('u4dratecs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mrateisd,open('u4drateis_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mratecsb,open('u4bratecs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mrateisb,open('u4brateis_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mratecsa,open('u4aratecs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mrateisa,open('u4arateis_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csfrac,open('u4mcsfrac_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('u4misfrac_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lencs,open('u4numcs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lenis,open('u4numis_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(csrate,open('u4mcsrate{0}.pkl'.format(TR),'wb'))
    #pickle.dump(israte,open('u4misrate_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mratecstotal,open('u4mratecst_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mrateistotal,open('u4mrateist_{0}.pkl'.format(TR),'wb'))
