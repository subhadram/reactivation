...
def main(trial):
    ...
    epsilon = np.arange(0.0e-9,0.01e-9, 0.01e-9)
            ...
            for j in range(trials):
               ...
               """
                ...
                for i in range(Nt250):
                    r_factorg3[10000*i +9500: 10000*(i+1) ] = 1.0
    ...
    # pickle.dump(csfrac,open('pulse2csfrac_{0}.pkl'.format(TR),'wb'))
    # pickle.dump(isfrac,open('pulse2isfrac_{0}.pkl'.format(TR),'wb'))
    # #pickle.dump(lencs,open('u2numcs_{0}.pkl'.format(TR),'wb'))
    # #pickle.dump(lenis,open('u2numis_{0}.pkl'.format(TR),'wb'))
    # pickle.dump(csrate,open('pulse2csrate{0}.pkl'.format(TR),'wb'))
    # pickle.dump(israte,open('pulse2israte_{0}.pkl'.format(TR),'wb'))
    # pickle.dump(mratecstotal,open('pulse2ratecst_{0}.pkl'.format(TR),'wb'))
    # pickle.dump(mrateistotal,open('pulse2rateist_{0}.pkl'.format(TR),'wb'))
