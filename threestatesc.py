...
def main(trial):   
    ...
    epsilon = np.arange(-1.0e-9, 1.1e-9, 0.5e-10)
    ...
    pickle.dump(csfrac,open('csfrac3_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('isfrac3_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('csfrac3_{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('isfrac3_{0}.pkl'.format(TR),'wb'))
