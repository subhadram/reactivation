...
def main(trial):
    ...
    jiearray = np.arange(0.4e-9, 1.4e-9, 0.05e-9)
    ...
    pickle.dump(csfrac,open('csfracjie_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('isfracjie_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('csratejie_{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('isratejie_{0}.pkl'.format(TR),'wb'))
