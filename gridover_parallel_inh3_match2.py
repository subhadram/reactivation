...
def main(trial):
    ...
    epsilon = np.arange(.20e-9, .23e-9, 5e-11)
    ...
    pickle.dump(rateg1,open('cstrace2_{0}.pkl'.format(TR),'wb'))
    pickle.dump(rateg2,open('istrace2_{0}.pkl'.format(TR),'wb'))
    pickle.dump(rateov,open('intrace2_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mratecs,open('mratecs_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mrateis,open('mrateis_{0}.pkl'.format(TR),'wb'))
