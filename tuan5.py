...
csfrac0 = np.zeros((len(ga),len(epsilon),len(aa),1000))
isfrac0 = np.zeros((len(ga),len(epsilon),len(aa),1000))
csfrac25 = np.zeros((len(ga),len(epsilon),len(aa),1000))
isfrac25 = np.zeros((len(ga),len(epsilon),len(aa),1000))
csfrac50 = np.zeros((len(ga),len(epsilon),len(aa),1000))
isfrac50 = np.zeros((len(ga),len(epsilon),len(aa),1000))
csfrac75 = np.zeros((len(ga),len(epsilon),len(aa),1000))
isfrac75 = np.zeros((len(ga),len(epsilon),len(aa),1000))
csfrac1 = np.zeros((len(ga),len(epsilon),len(aa),1000))
isfrac1 = np.zeros((len(ga),len(epsilon),len(aa),1000))
...
for tr in range(1,1001):
    ...
    with open('fracttimecsc25_{0}.pkl'.format(TR),'rb') as f: 
        csfrac25[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
    with open('fracttimeisc25_{0}.pkl'.format(TR),'rb') as f:
        isfrac25[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
        
for tr in range(1,1001):
    TR = str(tr)
    with open('fracttimecsc_{0}.pkl'.format(TR),'rb') as f: 
        csfrac50[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
    with open('fracttimeisc_{0}.pkl'.format(TR),'rb') as f:
        isfrac50[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
        

for tr in range(1,1001):
    TR = str(tr)
    with open('fracttimecsc75_{0}.pkl'.format(TR),'rb') as f: 
        csfrac75[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
    with open('fracttimeisc75_{0}.pkl'.format(TR),'rb') as f:
        isfrac75[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
        
        

for tr in range(1,1001):
    TR = str(tr)
    with open('fracttimecsc1_{0}.pkl'.format(TR),'rb') as f: 
        csfrac1[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
    with open('fracttimeisc1_{0}.pkl'.format(TR),'rb') as f:
        isfrac1[:,:,:,tr-1] = pickle.load(f,encoding = 'latin1')
...
for i in range(len(ga)):
    xdata = epsilon
    ydata = np.squeeze(np.mean(csfrac0[i,:,:,:],2))
    ydata1 = np.squeeze(np.mean(isfrac0[i,:,:,:],2))
    p1 = [-0.1, 0]
    p2 = [0.1, 0]
    xmax = np.max(epsilon)
    xmin = np.min(epsilon)
...
plt.plot(ga, slopes/slopes1,label = "correlation = 0")
plt.xlabel(r"$\mu$")
...
for i in range(len(ga)):
    xdata = epsilon
    ydata = np.squeeze(np.mean(csfrac25[i,:,:,:],2))
    ydata1 = np.squeeze(np.mean(isfrac25[i,:,:,:],2))
    p1 = [-0.1, 0]
    p2 = [0.1, 0]
    xmax = np.max(epsilon)
    xmin = np.min(epsilon)
...
plt.plot(ga, slopes/slopes1,label = "correlation = 0.25")
plt.xlabel(r"$\mu$")
plt.ylabel("ratio of slopes")
#plt.show()
...
for i in range(len(ga)):
    xdata = epsilon
    ydata = np.squeeze(np.mean(csfrac50[i,:,:,:],2))
    ydata1 = np.squeeze(np.mean(isfrac50[i,:,:,:],2))
    p1 = [-0.1, 0]
    p2 = [0.1, 0]
    xmax = np.max(epsilon)
    xmin = np.min(epsilon)
...
plt.plot(ga, slopes/slopes1,label = "correlation = 0.5")
plt.xlabel(r"$\mu$")
plt.ylabel("ratio of slopes")
#plt.show()
...
for i in range(len(ga)):
    xdata = epsilon
    ydata = np.squeeze(np.mean(csfrac75[i,:,:,:],2))
    ydata1 = np.squeeze(np.mean(isfrac75[i,:,:,:],2))
    p1 = [-0.1, 0]
    p2 = [0.1, 0]
    xmax = np.max(epsilon)
    xmin = np.min(epsilon)
...
plt.plot(ga, slopes/slopes1,label = "correlation = 0.75")
plt.xlabel(r"$\mu$")
plt.ylabel("ratio of slopes")
#plt.show()
...
for i in range(len(ga)):
    xdata = epsilon
    ydata = np.squeeze(np.mean(csfrac1[i,:,:,:],2))
    ydata1 = np.squeeze(np.mean(isfrac1[i,:,:,:],2))
    p1 = [-0.1, 0]
    p2 = [0.1, 0]
    xmax = np.max(epsilon)
    xmin = np.min(epsilon)
...
plt.plot(ga, slopes/slopes1,label = "correlation = 1.0")
plt.xlabel(r"$\mu$")
plt.ylabel("ratio of slopes")
plt.legend()
plt.show()
