...
def main(trial):
            ...
            for j in range(trials):
               ...
               """
                ...
                for i in range(Nt250):
                    r_factorg3[2500*i +2000: 2500*(i+1) ] = 1.0
    ...
    pickle.dump(csfrac,open('pulsecsfrac_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('pulseisfrac_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lencs,open('u2numcs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lenis,open('u2numis_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('pulsecsrate{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('pulseisrate_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mratecstotal,open('pulseratecst_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mrateistotal,open('pulserateist_{0}.pkl'.format(TR),'wb'))
