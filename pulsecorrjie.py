...
def main(trial):
    ...
    aarray = np.arange(2.5e-9,2.51e-9,5e-11)
            ...
            for j in range(trials):
               ...
               """
                ...
                for i in range(Nt250):
                    r_factorg3[10000*i +9000: 10000*(i+1) ] = 1.2
    ...
    pickle.dump(csfrac,open('pulsejiecsfrac_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('pulsejieisfrac_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lencs,open('u2numcs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lenis,open('u2numis_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('pulsejiecsrate{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('pulsejieisrate_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mratecstotal,open('pulsejieratecst_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mrateistotal,open('pulsejierateist_{0}.pkl'.format(TR),'wb'))
