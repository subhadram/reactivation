...
def main(trial):
    ...
    pickle.dump(csfrac,open('csfracojie_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('isfracojie_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('csrateojie_{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('israteojie_{0}.pkl'.format(TR),'wb'))
