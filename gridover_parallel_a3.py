...
def main(trial):
    ...
    aarray = np.arange(1.5e-9,2.01e-9,5e-11)
    ...
    pickle.dump(isfrac,open('isfraca8_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('csratea8_{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('isratea8_{0}.pkl'.format(TR),'wb'))
