...
def main(trial):
    ...
    aarray = np.arange(2.0e-9,2.5e-9,.5e-9)
    epsilon = np.arange(0.0e-9, 0.31e-9, 0.1e-10)
    ...
    pickle.dump(csfrac,open('csfracti_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('isfracti_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('csrateti_{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('israteti_{0}.pkl'.format(TR),'wb'))
