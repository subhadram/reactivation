...
def main(trial):
        ...
        for eps in range(len(epsilon)):
            ...
            for j in range(trials):
               ...
               """
                ...
                rfactorg3 = np.zeros(Nt)
                
                for i in range(Nt250):
                    rfactorg3[2500*i +2000: 2500*(i+1) ] = 1
                    
                plt.plot(tvector, rfactorg3)
                plt.show()
    ...
    pickle.dump(csfrac,open('u2gmcsfrac_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('u2gmisfrac_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lencs,open('u2numcs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(lenis,open('u2numis_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('u2gmcsrate{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('u2gmisrate_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mratecstotal,open('u2gmratecst_{0}.pkl'.format(TR),'wb'))
    pickle.dump(mrateistotal,open('u2gmrateist_{0}.pkl'.format(TR),'wb'))
