...
def main(trial):
    ...
    pickle.dump(csfrac,open('csfraco5_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('isfraco5_{0}.pkl'.format(TR),'wb'))
    pickle.dump(csrate,open('csrateo5_{0}.pkl'.format(TR),'wb'))
    pickle.dump(israte,open('israteo5_{0}.pkl'.format(TR),'wb'))
