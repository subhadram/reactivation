...
def main(trial):
    ...
    epsilon = np.arange(-1.0e-9, 1.1e-9, 10e-11)
        ...
        for eps in range(len(epsilon)):
            ...
            for j in range(trials):
               ...
               """
                ...
                #plt.plot(nbg)
                #plt.show()
                indices = np.where(nbg == 1)
                #print(indices[0][0])
                event_indices = []
                #print(high1[indices[0][0]])
                if len(indices[0])>0 and high1[indices[0][0]] ==0:
                    event_indices = indices[0][::2]
                if len(indices[0])>0 and high1[indices[0][0]] ==1:
                    event_indices = indices[0][1::2]
               
                for ie,ei in enumerate(event_indices):
                    if ei-500> 0 and ei+500<len(tvector)-1:
                ...
                nbg2 =high2[1:]!=high2[:-1]
                #plt.plot(nbg)
                #plt.show()
                indices2 = np.where(nbg2 == 1)
                #print(indices[0][0])
                event_indices2 = []
                #print(high1[indices[0][0]])
                if len(indices2[0])>0 and high2[indices2[0][0]] ==0:
                    event_indices2 = indices2[0][::2]
                if len(indices2[0])>0 and high2[indices2[0][0]] ==1:
                    event_indices2 = indices2[0][1::2]
                
                during2 = []
                after2 = []
                before2= []
                for ie,ei2 in enumerate(event_indices2):
                    if ei2-500> 0 and ei2+500<len(tvector)-1:
                    ...
                    #print(np.mean(rateov[ei:ei+500]))
                
                    
                #print(np.mean(keir2),"hi")
