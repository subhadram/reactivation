...
plt.imshow(2*timespent,  extent=(min(warray), max(warray), min(xys), max(xys)), aspect = 'auto') #vmin=0, vmax=1,
plt.plot(warray,xys,color="white",linewidth=4, zorder = 2)
...
clb = plt.colorbar()
clb.ax.set_title('Fraction of time active',fontsize=12)
plt.show()
"""
