...
# -*- coding: utf-8 -*-
"""
Created on Thu May  2 15:48:39 2024
...
for k in range(len(aa)):   
    ...
    for eps in range(len(epsilon)):
        ...
        for j in range(trials):
            ...
            J[inhind:,:inhind] = Jie
            J[group0si:group0ei,inhind:] = Jei
            J[group1si:inhind,inhind: ] = Jei2
            ...
            J[group1si:group1ei,group0si:group0ei] = J1d
            J[group2si:group2ei,group0si:group0ei] = J21
            J[group0si:group0ei,group1si:group1ei] = Jd1
            J[group0si:group0ei,group2si:group2ei] = Jd2
