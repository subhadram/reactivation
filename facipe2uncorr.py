...
def main(trial):
    ...
    #pickle.dump(mratecsd,open('fu3dratecs_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mrateisd,open('fu3drateis_{0}.pkl'.format(TR),'wb'))
    #pickle.dump(mratecsb,open('fu3bratecs_{0}.pkl'.format(TR),'wb'))
    ...
    pickle.dump(csfrac,open('pfuc125mcsfrac_{0}.pkl'.format(TR),'wb'))
    pickle.dump(isfrac,open('pfuc125misfrac_{0}.pkl'.format(TR),'wb'))
